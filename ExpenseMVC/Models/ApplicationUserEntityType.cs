    ...
    internal partial class ApplicationUserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "ExpenseMVC.Models.ApplicationUser",
            ...
            var preferredCurrency = runtimeEntityType.AddProperty(
                "PreferredCurrency",
                typeof(Currency),
                propertyInfo: typeof(ApplicationUser).GetProperty("PreferredCurrency", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(ApplicationUser).GetField("<PreferredCurrency>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
